  ...
  return (
    <div className='bg-white border-2 rounded-md border-black/50 shadow-md py-10 flex w-full'>
        ...
        <div className='space-y-7  w-full px-3'>
            ...
            <div className='flex justify-between flex-wrap md:flex-nowrap gap-x-7 md:py-3 pt-2 px-3 border-y-2 pb-4 border-black/50 w-full'>
                ...
                <button className='border-red-500 border-2 py-1 w-fit  text-red-500 px-4 rounded-md'>More</button>
            </div>
        </div>
    </div>
  )
